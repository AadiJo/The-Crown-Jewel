...
public class CharacterController2D : MonoBehaviour
{
    ...
    [HideInInspector] public bool m_Falling;
    [HideInInspector] public bool m_Running = false;            // Whether or not the player is grounded.
    ...
    public void Move(float move, bool crouch, bool jump)
    {
        ...
        if (m_Grounded || m_AirControl)
        {
            ...
            else
            {
                ...
                targetVelocity = new Vector2(move * 10f * 1.75f, m_Rigidbody2D.velocity.y);
